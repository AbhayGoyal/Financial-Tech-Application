	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(button1!=null)
		{
			 ServletContext servletContext=getServletContext();
	    	  RequestDispatcher rsd=servletContext.getRequestDispatcher("/Profile/changedprofile.html");
		...
		{
			 ServletContext servletContext=getServletContext();
	    	  RequestDispatcher rsd=servletContext.getRequestDispatcher("/Profile/changepass.html");
	    	 // rsd.include(request,response);
	    	  rsd.forward(request, response);
		}
		...
		{
			 /*ServletContext servletContext=getServletContext();
	    	  RequestDispatcher rsd=servletContext.getRequestDispatcher("/Bank/changepass.html");
	    	 // rsd.include(request,response);
	    	  rsd.forward(request, response);*/
		}
