...
/**
 * Servlet implementation class Bankput
 */
//@WebServlet("/Bankput")
public class Bankput extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			Class.forName("com.mysql.jdbc.Driver");//mam we can aldo use 
	         ...
	         request.getRequestDispatcher("/Bank/createbank2.jsp").forward(request, response);
